...
const PrivacyPolicy = () => {
  useEffect(() => {
    document.title = 'Privacy Policy | Mono Basket';
    window.scrollTo({
      top: 0,
    });
  }, []);
  return (
    <>
      ...
      <Container id={styles.privacy__policy}>
        <h3> Last updated: Mar 20, 2026</h3>
        <p>
          At MonoBasket, accessible from MonoBasket.om, one of our main priorities is the privacy of our visitors. This Privacy Policy document
          contains types of information that is collected and recorded by MonoBasket and how we use it. If you have additional questions or require
        ...
        <p className='mt-3'>
          ...
          shared and/or collect in MonoBasket.we may receive additional information about you such as your name, email address, phone number, the
        ...
        <h3>Log Files</h3>
        <p>
          MonoBasket follows a standard procedure of using log files. These files log visitors when they visit websites. All hosting companies do this
        ...
        <p>
          You may consult this list to find the Privacy Policy for each of the advertising partners of MonoBasket. Third-party ad servers or ad
          ...
          on MonoBasket, which are sent directly to users' browser. They automatically receive your IP address when this occurs. These technologies
          ...
          that you visit. Note that MonoBasket has no access to or control over these cookies that are used by third-party advertisers.
        </p>
        ...
        <p>
          ...
          advertisements and links that appear on MonoBasket, which are sent directly to users' browser. They automatically receive your IP address
          ...
          advertising content that you see on websites that you visit. Note that MonoBasket has no access to or control over these cookies that are
          used by third-party advertisers.
        </p>
        <p className='mt-3'>
          MonoBasket Privacy Policy does not apply to other advertisers or websites. Thus, we are advising you to consult the respective Privacy
        ...
        <p className='mt-3'>
          MonoBasket does not knowingly collect any Personal Identifiable Information from children under the age of 13. If you think that your child
